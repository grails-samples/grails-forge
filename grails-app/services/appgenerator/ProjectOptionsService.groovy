...
class ProjectOptionsService  implements  GrailsConfigurationAware {
    ...
    ProjectOptions defaultProjectOptions() {
        ...
        GrailsVersion version = versionList.getAt(0)
        List<Profile> profileList = profileListByProjectType(projectType, version)

        Profile profile = defaultProfile(projectType, profileList)
